...
from .mesh_info import IndicesInfo, UnkVertexInfo, MeshInfo, Vertices, MeshStreamInfo
...
# handlers = {
    ...
    # 0xF3BA66D1703DDED2: AudioUnk,
    # 0xD91716B58198721B: ControlName,
    # 0x9F9CD2EFBEC10AD0: AudioUnk3,
    # 0xD5273899E6B082DC: CoreRefCollection,
    # 0x12EE0426C2998362: AudioUnk4,
    # 0x7FC28103CEBC534C: Settings,
    # 0x5C2B37CF67300726: CoreRefCollection,
