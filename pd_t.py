...
def test_archive_set():
    ...
    file = Path(
        ...
        r"ds/artparts/characters/hgs_higgs/part_hgs_body_def.core"
        ...
        # r"F:\SteamLibrary\steamapps\common\Death Stranding\dump\ds\models\characters\sam_sam\core\sam_body_naked\model\skeletons\skeleton_jnt_c_b_000_root_helpers.core"
